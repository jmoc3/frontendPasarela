...
export default function ModalSucessTailwind({
  open,
  setOpen,
  title,
  message,
            ...
            >
              <div className="bg-gray-800 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  <div className="mx-auto flex size-12 shrink-0 items-center justify-center rounded-full bg-red-500/10 sm:mx-0 sm:size-10">
                    <CheckCircleIcon aria-hidden="true" className="size-6 text-accent1" />
                  </div>
              ...
              <div className="bg-gray-700/25 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button
                  ...
                  className="inline-flex w-full justify-center rounded-md bg-accent2 px-3 py-2 text-sm font-semibold text-white duration-300 hover:bg-accent3 sm:ml-3 sm:w-auto"
                >
                  Cerrar
                </button>
              </div>
